...
const config = {
    ...
    properties: [
        ...
        {key:'minPower',name: 'Minimum Power', description: 'minimum power in desclines', type: CyclingModeProperyType.Integer, default: 50},
    ]
}
...
export default class SmartTrainerCyclingMode implements CyclingMode {
    ...
    constructor(adapter: DaumAdapter, props?: Settings) {
        ...
        this.logger = new EventLogger('SmartTrainerMode')      
    ...
    calculateTargetPower(request, updateMode=true) {
        ...
        if ( prevData.speed!==undefined && prevData.slope!==undefined) {
            ...
            let power = calc.calculatePower(m,v,prevData.slope);
