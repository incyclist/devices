            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                protocol.attachSensors(this, Ant.FitnessEquipmentSensor, 'fitnessData')
                    ...
                    const iv = setInterval(() => __awaiter(this, void 0, void 0, function* () {
                        if (this.connected) {
                            clearInterval(iv);
                            return utils_2.runWithRetries(() => __awaiter(this, void 0, void 0, function* () {
                                try {
                                    yield this.sendTrackResistance(0.0);
                                    yield this.sendUserConfiguration(opts.userWeight || DEFAULT_USER_WEIGHT, opts.bikeWeight || DEFAULT_BIKE_WEIGHT, opts.wheelDiameter, opts.gearRatio);
                                    this.started = true;
                                    this.starting = false;
                                    resolve(true);
                                }
